...
constructs={'POLR2A_IDR1_15_repeats_w_UBTF_IDR4_drest_100'};
mol1={'POLR2A_IDR1_15_repeats'};
mol2={'UBTF_IDR4'}
mytitles={'POLR2A IDR1 15 repeats - UBTF IDR4'};
...
types{2}={'DE'};
types{3}={'QSTN'};
mycolor3=[[245 130 32]/255; [225 57 55]/255; [31 130 65]/255];
...
%print -painters -depsc 'two_molecule_POLR2A_IDR1_15_repeats_w_UBTF_IDR4_scaled_distance_map_drest_100.eps'
%print -painters -depsc 'two_molecule_POLR2A_IDR1_15_repeats_w_UBTF_IDR4_scaled_distance_map_w_colorbar_drest_100.eps'
