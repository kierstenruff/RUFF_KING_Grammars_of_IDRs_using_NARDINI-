...
constructs={'POLR1F_IDR1_w_MED15_IDR2'};
mol1={'POLR1F_IDR1'};
mol2={'MED15_IDR2'}
mytitles={'POLR1F IDR1 - MED15 IDR2'};
...
types{2}={'MILV'};
types{3}={'QNST'};
mycolor3=[[55 71 157]/255; [0 0 0]/255; [31 130 65]/255];
...
%print -painters -depsc 'two_molecule_POLR1F_IDR1_w_MED15_IDR2_scaled_distance_map.eps'
%print -painters -depsc 'two_molecule_POLR1F_IDR1_w_MED15_IDR2_scaled_distance_map_w_colorbar.eps'
